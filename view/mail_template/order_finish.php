...
<body style="padding: 0; margin: 0;">
  ...
  <div style="width:640px;margin:0 auto 30px auto;"><img src="http://www.unopan.tw/images/sample/logo_banner.jpg" alt=""></div>
      ...
      <tbody>
        <tr>
          <td style="padding:16px">
            <p style="margin:0 0 16px 0">親愛的&nbsp;vencen&nbsp;您好：</p>
            <p style="margin:16px 0 0 0">為了保護您的個人資料安全，本通知信將不顯示訂單明細。<br>
              我們已經收到您的訂購資訊，請至<br>
              <a style="color:#06c" href="https://www.tady.com.tw/member.php?type=orderlist" target="_blank">https://www.tady.com.tw/member.php?type=orderlist</a><br>
              感謝您對達迪實業有限公司的支持與信賴，如有任何需要服務的地方，<br>歡迎使用 E-mail與我們聯繫，再次感謝您的訂購。</p>
          </td>
        </tr>
      </tbody>
    </table>
  ...
  <p style="color:#666; font-size:12px; text-align:center; margin-top:30px;">Copyright © 2019 XXXX All Rights Reserved.</p>
