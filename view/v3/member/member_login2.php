...
if($_constant=='email'){
	...
	unset($validation['login_account']['email']);
...
<form class="form_start">
			<div class="Bbox_in_2c">
				<div>
					<div class="formItem">
						...
						<input type="text" id="login_account" name="login_account" placeholder="<?php echo $_login_account_text?>" autocomplete="off" <?php echo $_inputmode?> >
					</div>
					<div class="formItem">
			...
			<div class="formItem oneLine">
				...
				<input type="text" id="captcha" name="captcha" autocomplete="off" inputmode ="numeric"/><img id="valImageId" src="captcha.php" gwidth="100" gheight="40" /><a href="javascript:void(0)" class="icon-link" onclick="RefreshImage('valImageId')"><i class="fa fa-refresh" aria-hidden="true"></i><?php echo t('更新認證碼')?></a>
			</div>						
			<div>
