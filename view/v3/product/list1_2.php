		...
		<div class="item">
			...
			<div>
				...
				<?php if(isset($v['name2']) and $v['name2'] != ''):?>
					<div class="itemTitle">
						<a href="<?php echo $v['url1']?>">
							<span data-txtlen="18"><?php echo $v['name2']?></span> <!-- 2行24 -->
						</a>
						<small data-txtlen="44"><?php echo $v['detail']?></small>
					</div>
				<?php endif?>
				...
				<?php endif?>
				<?php if(0 and isset($v['describe']) and $v['describe'] != '')://簡述?>
				...
				<div class="Bbox_flexBetween">
					...
					<?php else:?>
						<?/* <a class="item_btn" href="<?php echo $v['url1']?>">More</a> */?>
						<?php // 拿掉addItemAddCart，就會回到舊的加入詢問車的方式 2019-10-25?>
						<a href="<?php echo $v['url_inquiry']?>" class="itemAddCart addItemAddCart item_btn" data-name="<?php echo $v['name2']?>" ><i class="fa fa-info-circle"></i> <span><?php echo t('加入詢問車')?></span></a>
					<?php endif?>
				</div>
			</div>
