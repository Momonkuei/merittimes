...
<?php endif?>
	...
	<div class="Bbox_in_2c_L6"><?php // 2018-01-24 查理說經理說，從L4改成L6?>
		<div>
			<div class="">
				...
				<div class="itemSlick">
					<?php if(isset($images_big)):?>
						<?php foreach($images_big as $k => $v):?>
							<div><a class="swipebox" rel="proShow" href="<?php echo $v['pic']?>" title="<?php echo $v['name']?>"><div class="itemImg"><img src="<?php echo $v['pic']?>"></div></a></div>
						<?php endforeach?>
					<?php endif?>
				</div>
			...
			<div>
				<<?php echo $_sptxt?> class="itemTitle"><?php echo $product['name']?></<?php echo $_sptxt?>>
				<div class="itemInfo"><?php echo $product['item_name']?></div>
				<div class="itemInfo"><?php echo $product['name2']?></div>
...
<?php if(0):?>
	...
	<meta property="og:type"          content="website"  m="head_end" />
	<meta property="og:title"         content="<?php echo $product['name']?>"  m="head_end" />
	<meta property="og:description"   content="<?php echo strip_tags($product['name2'])?>"  m="head_end"  />
