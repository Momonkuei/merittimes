	...
	<div class="itemList newsListType2 ">
		<div l="layer" ls="_general_item">
			<div class="item" l="list">
				...
				<a href="{/url2/}">									
					<div class="dateStyle">
						<span class="dateD">{/day/}</span>
						<span class="dateM">{/month/}</span>
						<span class="dateY">{/year/}</span>
					</div>
					<div class="itemTitle"> <span>{/name/}</span> </div>
					<div class="itemContent" data-txtlen="150">{/content/}</div>									
				</a>
			</div>
		</div>
