			...
			<div> 
				<div>				
					...
					<div class="formItem money _regular">
						...
						<div>
							<input type="radio" name="regular_money" id="regular_500" value="500" <?php if(!empty($row_data['regular_money']) && $row_data['regular_money'] =="500" ){?>checked<?php }?> >新台幣 500元整<br>
							<input type="radio" name="regular_money" id="regular_1000" value="1000" <?php if(!empty($row_data['regular_money']) && $row_data['regular_money'] =="1000" ){?>checked<?php }?> >新台幣 1000元整<br>
							<input type="radio" name="regular_money" id="regular_2000" value="2000" <?php if(!empty($row_data['regular_money']) && $row_data['regular_money'] =="2000" ){?>checked<?php }?> >新台幣 2000元整<br>
							<input type="radio" name="regular_money" id="regular_5000" value="5000" <?php if(!empty($row_data['regular_money']) && $row_data['regular_money'] =="5000" ){?>checked<?php }?> >新台幣 5000元整<br>
							<input type="radio" name="regular_money" id="regular_money_other" value="other" <?php if(!empty($row_data['regular_moneyCustom']) ){?>checked<?php }?> >其他金額
					...
					<div class="formItem money">
						...
						<div>
							<input type="radio" name="money" id="money_1000" value="1000" <?php if(!empty($row_data['money']) && $row_data['money'] =="1000" ){?>checked<?php }?> >新台幣 1000元整<br>
							<input type="radio" name="money" id="money_2000" value="2000" <?php if(!empty($row_data['money']) && $row_data['money'] =="2000" ){?>checked<?php }?> >新台幣 2000元整<br>
							<input type="radio" name="money" id="money_5000" value="5000" <?php if(!empty($row_data['money']) && $row_data['money'] =="3000" ){?>checked<?php }?> >新台幣 3000元整<br>
							<input type="radio" name="money" id="money_10000" value="10000" <?php if(!empty($row_data['money']) && $row_data['money'] =="10000" ){?>checked<?php }?> >新台幣 10000元整<br>
							<input type="radio" name="money" id="money_other" value="other" <?php if(!empty($row_data['moneyCustom']) ){?>checked<?php }?> >其他金額
					...
					<div class="formItem">
						...
						<input type="radio" name="sameName" id="sameName" value="1">同姓名
					</div>
					<!-- <div class="formItem">
					...
					<div class="formItem">
						<label>身分別：</label>
						<input type="radio" name="identity" id="identityPerson" value="1" <?php if( (isset($row_data['identity']) && $row_data['identity']=='1') or !isset($row_data['identity']) ):?>checked <?php endif?>>個人
						<input type="radio" name="identity" id="identityCompany" value="2" <?php if(isset($row_data['identity']) && $row_data['identity']=='2'):?>checked <?php endif?>>公司
					</div>
					<?php if(0): //#44238?>
					<div class="formItem">
					...
					<div class="formItem">
						...
						<input type="radio" name="receipt" id="receipt" value="1" >需要
						<input type="radio" name="receipt" id="receipt" value="2" checked>不需要
					</div>
					<div class="formItem">
					...
					<div class="formItem">
						<label>備註：</label>
						<textarea cols="30" rows="10" name="memo" class="memo"></textarea>
					</div>					
