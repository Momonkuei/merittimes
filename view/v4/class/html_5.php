<?
include _BASEPATH . '/../source/class/post_5.php';
?>
                ...
                <div class="class-border">
                    ...
                    <? if (!empty($billboard_list)) { ?>
                        ...
                        <section class="class-billboard">
                                ...
                                <div class="row">
                                    ...
                                    ?>
                                        <div class="col-lg-6 class-billboard-list">
                                            <div class="item">
                                                <a href="class_<?= $this->data['ml_key'] ?>_15.php?bid=<?= $v['id'] ?>">
                                                    <div class="itemImg2">
                            ...
                            <div class="btn-group class-btn-group">
                                ...
                                <a class="btn-readMore btn-text" href="class_tw_11.php">
                                    了解更多
                    ...
                    <? if (!empty($pic_list)) { ?>
                        ...
                        <section class="class-photo-album">
                            ...
                            <div class="btn-group class-btn-group">
                                <a class="btn-readMore btn-text" href="class_tw_12.php">
                                    了解更多
                                    <i class="fa fa-arrow-right" aria-hidden="true"></i>
                                </a>
                            </div>
                    ...
                    <? if (!empty($vido_list)) { ?>
                        ...
                        <section class="class-video-album">
                            ...
                            <div class="btn-group class-btn-group class-btn-group-last">
                                ...
                                <a class="btn-readMore btn-text" href="class_tw_13.php">
                                    了解更多
                                    <i class="fa fa-arrow-right" aria-hidden="true"></i>
                                </a>
                            </div>
