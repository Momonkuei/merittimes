...
<div class="newsD_main">
	...
	<div class="col-lg-4 newsAside">
		<?php if(0)://#42448?>
		<div class="asideImg"><a href=""><img src="_i/assets/upload/news/7776d62cd2a1a9cf7ec30ee95624fa1a.jpg" alt=""></a></div>
		<?php endif?>
		<?php if(isset($data[$ID]['right_list']) && count($data[$ID]['right_list'])):?>
		<div class="asideNewsListBox">
			<div class="asideNewsList2">
				<ul>
					<?php foreach ($data[$ID]['right_list'] as $key => $value):?>					
					<li><a href="<?php echo $this->data['router_method'].'_'.$this->data['ml_key'].'.php?id='.$value['id']?>"><?php echo $value['topic']?></a><span class="date"><?php echo date('Y-m-d',strtotime($value["date1"]))?></span></li>
				<?php endforeach?>
				</ul>
			</div>
		</div>
