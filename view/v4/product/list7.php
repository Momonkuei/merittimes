...
<div class="productListBlock productListStyle07">
  ...
  <div  class="col-lg-4 col-sm-6 proItem">
    <div class="proItemBorder">
      ...
      <div class="productBrief">
        ...
        <div class="productBriefText">敘述文字</div>
        <?php if(0)://Ming說隱藏?>
        <div><a class="moreText" href="">MORE</a></div>
        <?php endif?>
        <div class="cartBox"><a class="btn-cis1" href=""><i class="fa fa-info-circle"></i> <span>加入詢問</span></a></div>
      </div>
    </div>
  </div>
  ...
  <div  class="col-lg-4 col-sm-6 proItem">
    <div class="proItemBorder">
      ...
      <div class="productBrief">
        ...
        <div class="underLine"></div>
        <div class="productBriefText">敘述文字敘述文字敘述文字敘述文字敘述文字敘述文字敘述文字敘述文字敘述文字敘述文字敘述文字敘述文字敘述文字敘述文字</div>
        <?php if(0)://Ming說隱藏?>
        <div><a class="moreText" href="">MORE</a></div>
        <?php endif?>
        <div class="cartBox"><a class="btn-cis1" href=""><i class="fa fa-info-circle"></i> <span>加入詢問</span></a></div>
