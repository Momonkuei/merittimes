...
<div class="productListBlock productListStyle04">

 <div class="col-6 col-lg-3 col-sm-6 proItem">
  <a href="">
   <div class="itemImg itemImgHover square hoverEffect1"><?php //預設正方形 移除 square 會變成4:3 ?>
  ...
  <div>
   ...
   <div class="cartBox">
    <div class="cartBox_cart"><a href="productsInquiry.php"><i class="fa fa-info-circle" aria-hidden="true"></i><span>加入詢問車</span></a></div>
    <div class="cartBox_price"><span>$299</span></div>
   </div>
  </div>
 </div>
 ...
 <div class="col-6 col-lg-3 col-sm-6 proItem">
  ...
  <div>
   ...
   <div class="cartBox">
    <div class="cartBox_cart"><a href="productsInquiry.php"><i class="fa fa-info-circle" aria-hidden="true"></i><span>加入詢問</span></a></div>
    <div class="cartBox_price"><span>$299</span></div>
   </div>
  </div>
 </div>
