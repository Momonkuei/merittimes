<?php if(isset($data[$ID])):?>
	...
	<div class="row">
		<div class="col-12">
			<<?php echo $_sptxt?> class="prod_title itemTitle centerProTitle"><?php echo $product['name']?></<?php echo $_sptxt?>>
		</div>
	</div>
	...
	<div class="prod_blk4">
	  <div class="row prod_slider">
		<div class="col-lg-7">
			...
			<div class="slider-nav slideNavBottom">
		...
		<div class="prod_info">
			...
			<div class="editorBlock"><?php echo $product['name2']?></div>
		</div><!-- .prod_info -->
		<?php endif?>
