...
<ul class="cowboySidemenu_3" l="layer" ls="lll" debug="">
	<li l="list" attr1="">
...
<?php if(0):?><!-- body_end -->
<script>
	if($('.cowboySidemenu_3').length){
		$(window).on('load',function(){
			$('.cowboySidemenu_3 .submenu').parent('li').addClass('moremenu');
			$('.cowboySidemenu_3 .submenu').siblings('a').removeAttr('href').attr('href', 'javascript:;');

			$('.cowboySidemenu_3 .submenu').hide();
			$('.cowboySidemenu_3 a.active').addClass('open');
			$('.cowboySidemenu_3 a.active').parents('.submenu').siblings('a').addClass('active open');
			$('.cowboySidemenu_3 a.active').parents('.submenu').addClass('open').show();
			$('.cowboySidemenu_3 a.active').siblings('.submenu').addClass('open').show();
		});

		$('.cowboySidemenu_3 a').click(function(){
