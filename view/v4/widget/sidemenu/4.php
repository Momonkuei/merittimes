...
<ul class="cowboySidemenu_4" l="layer" ls="lll" debug="">
	<li l="list" attr1="">
	...
	<li class="moremenu">	
		<a class="open active" href="javascript:;">十上力牠目木幾</a>
		<ul class="submenu">
			<li>
				<a class="open active" href="javascript:;">現語那到水晚穿今</a>
			</li>
			<li>
...
<?php if(0):?><!-- body_end -->
<script>
	if($('.cowboySidemenu_4').length){
		$(window).on('load',function(){
			$('.cowboySidemenu_4 .submenu').parent('li').addClass('moremenu');
			$('.cowboySidemenu_4 .submenu').siblings('a').removeAttr('href').attr('href', 'javascript:;');

			$('.cowboySidemenu_4 .submenu').hide();
			$('.cowboySidemenu_4 a.active').addClass('open');
			$('.cowboySidemenu_4 a.active').parents('.submenu').siblings('a').addClass('active open');
			$('.cowboySidemenu_4 a.active').parents('.submenu').addClass('open').show();
			$('.cowboySidemenu_4 a.active').siblings('.submenu').addClass('open').show();
		});

		$('.cowboySidemenu_4 a').click(function(){
