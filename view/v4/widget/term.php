<div id="memberTerm_modal" class="modal">
	<?php 
	//if(isset($this->data['sys_configs']['customerarticle1_'.$this->data['ml_key']]) && $this->data['sys_configs']['customerarticle1_'.$this->data['ml_key']]!=''):?>
		<?php //echo $this->data['sys_configs']['customerarticle1_'.$this->data['ml_key']]?>
	<?php //endif?>
