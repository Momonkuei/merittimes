<?
include _BASEPATH . '/../source/apply/post_8.php';
?>
      ...
      <div class="application-form application-form-detail form-border-no-title  ">
        <form target="" method="POST" name="applicationForm" id="form_data" class="row cont_form" autocomplete="off" onsubmit="return validateForm()">
              ...
              <div class="row">
                <div class="col-lg-4">
                  <div class="address-detail">
                    郵遞區號
                    <input type="text" id="postal" name="postal" placeholder="請輸入郵遞區號" value="<?= (!empty($address[0]) ? $address[0] : '') ?>">
                  </div>
          ...
          <div class="form_group col-lg-6">
            ...
            <input type="text" id="line_id" name="line_id" placeholder="請輸入LineID" value="<?= $member_array['line_id'] ?>">
          </div>
