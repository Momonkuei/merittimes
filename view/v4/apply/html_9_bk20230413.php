            ...
            <div class="application-form ">
                <form action="" method="POST" name="applicationForm" id="form_data" class="row cont_form" enctype="multipart/form-data" autocomplete="off" onsubmit="return validateForm()">
                    ...
                    <? if (!empty($semester_array)) { ?>
                        <div class="form_group col-lg-6">
                            ...
                            <select name="cars" id="cars" class="select-radio">
                                <option value="<?= $semester_array['id'] ?>"><?= $semester_array['topic'] ?></option>
                    ...
                    <div class="form_group col-lg-6">
                        ...
                        <input type="text" id="president_name" name="president_name" placeholder="請輸入姓名" value="<?= $writeplan_array['president_name'] ?>">
                    </div>
                    <div class="form_group col-lg-6">
                        <label class="must-label">連絡電話<span>：</span>
                        </label>
                        <div class="phone-detail ">
                            <input type="tel" id="landline" name="landline" placeholder="請輸入號碼(ex:04-1234-557)" value="<?= $writeplan_array['landline'] ?>">
                            <div class=" linkmark">
                                –
                            </div>
                            <input type="tel" id="extension" name="extension" placeholder="分機" value="<?= $writeplan_array['extension'] ?>" class="extension">
                        </div>
                    </div>
                    <div class="form_group col-lg-6">
                        <label class="must-label">行動電話<span>：</span>
                        </label>
                        <input type="tel" id="phone" name="phone" placeholder="請輸入號碼" value="<?= $writeplan_array['phone'] ?>">
                    </div>
                    <div class="form_group col-lg-6">
                        <label class="">E-mail<span>：</span>
                        </label>
                        <input type="email" id="email_p" name="email_p" placeholder="請輸入信箱" value="<?= $writeplan_array['email'] ?>">
                    </div>
                    <div class=" col-12">
                    ...
                    <div class="form_group col-lg-12">
                        ...
                        <textarea id="description" name="description" rows="5" cols="33" placeholder="請在此輸入計畫簡述"><?= $writeplan_array['description'] ?></textarea>
                    </div>
                    <div class="form_group col-12">
                        <label class="">實施時間<span>：</span>
                        </label>
                        <input type="date" id="implement_date" name="implement_date" placeholder="請選擇日期" value="<?= date('Y-m-d', strtotime($writeplan_array['implement_date'])) ?>">
                    </div>
                    <div class="form_group col-lg-12">
                        <label class="must-label">方式及歷程<span>：</span>
                        </label>
                        <textarea id="course" name="course" rows="5" cols="33" placeholder="請在此輸入方式及歷程"><?= $writeplan_array['course'] ?></textarea>
                    </div>
                    <div class="form_group col-lg-12">
                        <label class="">備註說明<span>：</span>
                        </label>
                        <textarea id="remark" name="remark" rows="5" cols="33" placeholder="請在此輸入備註說明"><?= $writeplan_array['remark'] ?></textarea>
                    </div>
                    ...
                    <div class="form_group col-lg-6">
                        <div class='file-input'>
                            ...
                            <span class='button'>選擇檔案</span>
                            <span class='label' data-js-label>未選擇檔案</span>
                            <a href="javascript:;" class="delete-file" data-id="<?=$_GET['id']?>" data-name="writeplan" data-class="<?=$writeplan_array['file2']?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                        </div>
                            ...
                            <div class="col-12 col-lg-4">
                                <div class="row label-group">
                                    <div class="footer-label application-field ">
                                        申請報份： <input type="text" id="apply_num" name="apply_num" placeholder="請輸入數量" value="<?= $writeplan_array['apply_num'] ?>"> 份
                                    </div>
                                </div>
