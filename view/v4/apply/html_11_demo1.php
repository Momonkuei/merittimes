<?
include _BASEPATH . '/../source/apply/post_r.php';
?>
        ...
        <form target="" method="POST" name="applicationForm" id="form_data" class="row cont_form" autocomplete="off" onsubmit="return validateForm()">
          ...
          <div class="form_group col-lg-12 address-group-title">
            ...
            <div class="address">
              <!-- 地址第一段 -->
              <div class="row">
                <div id="twzipcode" class="col-lg-8">
                  <div class="col-lg-4 col-md-4">
                    <div class="address-detail">
                      郵遞區號
                      <!-- <input type="text" id="postal" name="postal" placeholder="請輸入郵遞區號" value=""> -->
                      <div data-role="zipcode" data-style="form-control" data-name="zipcode" data-value="請輸入郵遞區號" id="postal" name="postal" class='zipcode'></div>
                    </div>
                  ...
                  <div class="col-lg-8 col-md-8">
                    ...
                    <div class="row">
                      <div class="col-6">
                        <div data-role="county" data-style="select-radio" data-name="county" data-value=""></div>
                      </div>

                      <div class="col-6">
                        <div data-role="district" data-style="select-radio" data-name="district" data-value=""></div>
                      </div>
                    </div>
              ...
              <div class="row">
                <div class="col-lg-4">
                  <div class="address-detail">
                    <input type="number" id="part" name="part" placeholder="請輸入數字" value="">
                    段
                  </div>
                ...
                <div class="col-lg-4">
                  <div class="address-detail">
                    <input type="number" id="lane" name="lane" placeholder="請輸入數字" value="">
                    巷
                  </div>
                ...
                <div class="col-lg-4">
                  <div class="address-detail">
                    <input type="number" id="alley" name="alley" placeholder="請輸入數字" value="">
                    弄
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-lg-4">
                  <div class="address-detail">
                    <input type="number" id="no_of" name="no_of" placeholder="請輸入數字" value="">
                    號
                    之
                    <input type="number" id="no_of2" name="no_of2" placeholder="請輸入數字" value="">
                  </div>
                </div>
                <div class="col-lg-4">
                  <div class="address-detail">
                    <input type="number" id="lou_of" name="lou_of" placeholder="請輸入數字" value="">
                    樓
                    之
                    <input type="number" id="lou_of2" name="lou_of2" placeholder="請輸入數字" value="">
                  </div>
          ...
          <div class="form_group col-lg-6">
            ...
            <div class="phone-detail ">
              ...
              <input type="tel" id="landline" name="landline" placeholder="請輸入號碼(ex:04-1234-557)" value="">
              <div class=" linkmark">
                –
              </div>

              <input type="text" id="extension" name="extension" placeholder="分機" value="" class="extension">
          ...
          <div class="form_group col-lg-6">
            ...
            <input type="text" id="line_id" name="line_id" placeholder="請輸入號碼" value="">
          </div>

          <div class="form_group col-lg-6">
            <label class="">傳真<span>：</span>
            </label>
            <input type="tel" id="fax" name="fax" placeholder="請輸入號碼(ex:04-1234-567)" value="">
          </div>
...
<script m="body_end">
  ...
  function validateForm() {
    var is_stop = false;
    $check_array = ['school_name', 'school_compilation', 'the_code', 'school_type', 'administrative', 'contact_person', 'job_title', 'account', 'password', 'landline', 'phone', 'email'];
