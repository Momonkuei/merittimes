        ...
        <div class="form-border">
            ...
            <div class="application-form  teacher-account-management-form addclassdiv" style="display:none">
                <form method="POST" name="applicationForm" id="form_data" class="row cont_form" autocomplete="off">
                    ...
                    <div class="form_group col-lg-6">
                        <label class="must-label">申請期別(可以複選所需期別) <a data-fancybox='' data-options='{"touch" : false}' data-src="#applicationPeriod" href="javascript:;" class="remind-mark">?</a><span>：</span>
                        </label>
                    ...
                    <div class="form_group col-lg-6">
                        ...
                        <input type="text" id="login_account" name="login_account" placeholder="請輸入登入帳號" value="" autocomplete="off">
                        <p class="show_acct_text" style="color:red;display:none;">您輸入的帳號已被註冊，請重新填寫！</p>
                    </div>
                    <div class="form_group col-lg-6">
                        <label class="must-label">密碼 <span>：</span>
                        </label>
                        <input type="password" id="login_password" name="login_password" placeholder="請輸入密碼" value="" autocomplete="off">
                    </div>
                    <div class="form_group col-lg-6">
                        <label class="must-label">再次輸入密碼 <span>：</span>
                        </label>
                        <input type="password" id="login_password2" name="login_password2" placeholder="請再輸入密碼" value="" autocomplete="off">
                    </div>
...
<div id="applicationPeriod" class="modal modal_half sign-off-form" style="display: none;">
    ...
    <div class="content">
        <p>
            在第一次建立完成老師帳號資料，之後若「<span>同樣班級有申請新的學期之讀報</span>」，可以在此複選欄位，直接增加新的學期選項，就不用新學期再次重新建立新的老師帳號資料囉!</p>

        <p>比如在「112學年度第1學期」第一次建立A老師帳號，在112學年度第2學期，A老師此班級也有申請讀報，此時可以在此複選欄位，直接新增「112學年度第2學期」，再將資料送出後即可完成。</p>
