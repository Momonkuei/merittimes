        ...
        <div>
          <ul class="subNavMenu">
            <li class="hide">
              <a href="">
                <div class="inner">
                  <i class="fa fa-info-circle" aria-hidden="true"></i><span>其他項目</span>
                </div>
              </a>
            </li>
            <li>
              <a href="">
                <div class="inner">
                  <i class="fa fa-envelope-o" aria-hidden="true"></i><span>其他項目</span>
                </div>
              </a>
            </li>
            <li class="hide">
              <a href="">
                <div class="inner">
                  <i class="fa fa-shopping-bag" aria-hidden="true"></i><span>其他項目</span>
                </div>
              </a>
            </li>
          </ul>
