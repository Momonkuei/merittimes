				...
				<div class="row">
					<div class="class-selection class-web-label col-xl-3">
						...
						<select name="school" id="school" class="select-radio">
							...
							<!-- <option value="">請選擇學校1</option>
							<option value="">請選擇學校2</option>
							<option value="">請選擇學校3</option>
							<option value="">請選擇學校4</option>
							<option value="">請選擇學校5</option>
							<option value="">請選擇學校6</option> -->
...
<script m="body_end">
	$(function() {
		...
		$('#school').one('select2:open', function(e) {
			$('input.select2-search__field').prop('placeholder', '請輸入學校名稱');
		});
