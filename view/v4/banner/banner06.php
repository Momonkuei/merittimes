<div class="bannerBlock">
  <div class="bannerStyle06">
    <div class="swiper-container bnr_s6 loading">
      <div class="swiper-wrapper">
		...
		<?php if(isset($data[$ID])):?>
			<?php foreach($data[$ID] as $k => $v):?>
				...
				<div class="swiper-slide" data-test-set="test" style="background-image:url('<?php echo $v['pic1g']?>')">
		...
		<?php if(0):?>
        <div class="swiper-slide" data-test-set="test" style="background-image:url('images_v4/banner/bannerStyle03-1.jpg')">
