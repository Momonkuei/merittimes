	...
	<?php if($this->data['layoutv2_sections_select'] == '1'):?>
		...
		<?php if($this->data['router_class'] == 'shoppingcar' and isset($_SESSION['authw_admin_id']) and $_SESSION['authw_admin_id'] != ''):?>
			...
			<div class="form-group">
				<label class="col-xs-3 control-label"><?php echo G::t(null,'登入帳號')?> (E-Mail)：</label>
				<div class="col-xs-9">
			...
			<div class="form-group">
				<label class="col-xs-3 control-label"><?php echo G::t(null,'姓名')?></label>
				<div class="col-xs-9">
					<p class="form-control-static">
						<?php echo $row['name']?> <?php if($row['sex'] == '1'):?><?php echo G::t(null,'先生')?><?php else:?><?php echo G::t(null,'小姐')?><?php endif?>
					</p>
				</div>
			</div>

			<div class="form-group">
				<label class="col-xs-3 control-label"><?php echo G::t(null,'聯絡電話')?></label>
				<div class="col-xs-9">
					<p class="form-control-static">
						<?php echo $row['phone']?>
					</p>
			...
			<div class="form-group ">
				<label class="col-xs-3 control-label"><?php echo G::t(null,'地址')?></label>
...
XXX;
$this->data['BODY_START'] = str_replace('請輸入',G::t(null,'請輸入'),$this->data['BODY_START']);
?>
		<?php endif?>
...
?>
		...
		<?php endif?>
			...
			<form class="form-horizontal" action="" method="post" name="form_data" id="form_data">
				<?php if($this->data['router_class'] == 'shoppingcar'):?>
					<div class="form-group">
						<label class="col-xs-3 control-label"><small class="cis2">※</small><?php echo G::t(null,'登入帳號 ')?>(E-Mail)</label>
						<div class="col-xs-9">
				...
				<?php if($this->data['router_class'] == 'shoppingcar' ):?>
					<div class="form-group">
						<label class="col-xs-3 control-label"><small class="cis2">※</small><?php echo G::t(null,'密碼')?></label>
						<div class="col-xs-9">
							<input type="password" class="form-control" id="login_password" name="login_password" value="<?php echo $this->d('login_password',$key)?>" placeholder="<?php echo G::t(null,'密碼由英文、數字組成。')?>">
						</div>
					</div>

					<div class="form-group">
						<label class="col-xs-3 control-label"><small class="cis2">※</small><?php echo G::t(null,'密碼確認')?></label>
						<div class="col-xs-9">
							<input type="password" class="form-control" id="login_password_confirm" name="login_password_confirm" value="<?php echo $this->d('login_password_confirm',$key)?>" placeholder="<?php echo G::t(null,'請再輸入一次密碼')?>">
						</div>                                
					</div>
				<?php elseif($this->data['router_class'] == 'guest'):?>
					<div class="form-group">
						<label class="col-xs-3 control-label"><small class="cis2">※</small><?php echo G::t(null,'密碼')?></label>
						<div class="col-xs-9">
							<input type="password" class="form-control" id="login_password" name="login_password" placeholder="<?php echo G::t(null,'密碼由英文、數字組成。')?>">
						</div>
					</div>
					...
					<div class="form-group">
						<label class="col-xs-3 control-label"><small class="cis2">※</small><?php echo G::t(null,'密碼確認')?></label>
						<div class="col-xs-9">
							<input type="password" class="form-control" id="login_password_confirm" name="login_password_confirm" placeholder="<?php echo G::t(null,'請再輸入一次密碼')?>">
						</div>                                
					</div>
				<?php endif?>

				<div class="form-group">
					<label class="col-xs-3 control-label"><small class="cis2">※</small><?php echo G::t(null,'姓名')?></label>
					<div class="col-xs-6">
						<input type="text" class="form-control" id="name" name="name" value="<?php echo $this->d('name',$key)?>" />
					</div>
					<label class="radio-inline">
					  <input type="radio" name="sex" value="1" <?php echo $this->dradio('sex','1',$key,true)?> /> <?php echo G::t(null,'先生')?>
					</label>
					<label class="radio-inline">
					  <input type="radio" name="sex" value="2" <?php echo $this->dradio('sex','2',$key)?> /> <?php echo G::t(null,'小姐')?>
					</label>
				</div>
				<div class="form-group">
					<label class="col-xs-3 control-label"><small class="cis2">※</small><?php echo G::t(null,'生日')?></label>
					<div class="col-xs-9">
				...
				<div class="form-group">
					<label class="col-xs-3 control-label"><small class="cis2">※</small><?php echo G::t(null,'聯絡電話')?></label>
					<div class="col-xs-9">
						<input type="text" class="form-control" id="phone" name="phone" placeholder="<?php echo G::t(null,'請填寫聯絡電話，格式如 : 0425674185 或 0912345678')?>" value="<?php echo $this->d('phone',$key)?>" />
					</div>
				</div>
				<div class="form-group ">
					<label class="col-xs-3 control-label"><small class="cis2">※</small><?php echo G::t(null,'地址')?></label>

					<div class="col-xs-9 margin_base_b">
						<div id="twzipcode"></div>
					</div>
					<div class="col-xs-9 col-xs-offset-3">
						<input type="text" class="form-control" id="addr" name="addr" placeholder="<?php echo G::t(null,'請填寫完整地址')?>"  value="<?php echo $this->d('addr',$key)?>" />
					</div>
				...
				<?php if($this->data['router_class'] == 'guest'):?>
					<div class="form-group">
						<label class="col-xs-3 control-label"><small class="cis2">※</small><?php echo G::t(null,'驗證碼')?></label>
						<div class="col-xs-5">
					...
					<div class="modal-dialog modal-lg">
						<div class="modal-content">
							...
							<div class="col-sm-10 col-sm-offset-1">
								<div class="row">
									<div class="col-sm-12">
										<p class="title-sm title-c text-center margin_base_t">Member Notice
										<?php if($this->data['ml_key']=='tw'):?>
										<span class="title-c">會員需知</span>
										<?php endif?>
										</p>
									</div>
									<div class="col-sm-12">
				...
				<div class="form-group">
					<div class="col-sm-offset-3 col-sm-9">
						<?php if($this->data['router_class'] == 'guest'):?>
						<div class="col-md-12">
							<p><?php echo G::t(null,'感謝您，填妥本表單相關資料，我們立刻為您註冊會員資格。')?> </p>
							<p><?php echo G::t(null,'若有任何問題歡迎來電聯絡。')?></p>
							<p><?php echo G::t(null,'若想知道會員詳請，請參考')?> <a class="btn btn-link" data-toggle="modal" data-target=".membernotice"><?php echo G::t(null,'會員需知')?></a></p>
							<input id="terms" type="checkbox" checked="checked" /> <?php echo G::t(null,'接受會員條款')?>
						</div>
						<?php endif?>
	...
	<?php elseif($this->data['layoutv2_sections_select'] == '2'):?><?php // 忘記密碼?>
		<div  class="col-md-10 col-md-offset-1">
			...
			<form class="form-horizontal" action="" method="post" name="form_data" id="form_data">
				<div class="form-group">
					<label class="col-xs-3 control-label"><small class="cis2">※</small><?php echo G::t(null,'請輸入您的帳號')?></label>
					<div class="col-xs-9">
						 <input type="text" class="form-control" id="login_account" name="login_account" />
					</div>
				</div>
