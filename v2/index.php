...
if(!function_exists('std_class_object_to_array_ggg')){
	function std_class_object_to_array_ggg($stdclassobject)
	{
		$_array = is_object($stdclassobject) ? get_object_vars($stdclassobject) : $stdclassobject;

		foreach ($_array as $key => $value) {
			$value = (is_array($value) || is_object($value)) ? std_class_object_to_array_ggg($value) : $value;
			$array[$key] = $value;
		}
...
include '_i/web/controllers/layoutv2/layout_site-'.$this->data['router_method'].'.php';
...
$tree = std_class_object_to_array_ggg($topLevel);
...
$page = array(
	array(
		...
		'hole' => array(
			...
			// W01的動態首頁
			// array(
			// 	'file' => 'home/indexcontent1',
			// 	'hole' => array(
			// 		array(
			// 			'hole' => array(
			// 				array('file' => 'home/home_marquee'),
			// 				array('file' => 'home/home_ad'),
			// 				array('file' => 'home/home_content'),
			// 			),
			// 		),
			// 	),
			// ),
			...
			// w02
			// array('file' => 'home/index_content_02'),
			// array('file' => 'home/indexcontent2'),

			// W03
			// array('file' => 'home/index_content_03'),
			...
			// w07
			// array('file' => 'home/indexcontent7'),

			// w08
			// array('file' => 'home/index_content_08'),

			// w09
			// array('file' => 'home/index_content_09'),
			// array('file' => 'home/indexcontent9'),

			// w10
			// array('file' => 'home/index_content_10'),

			// w12
			//array('file' => 'home/index_content_12'),

			// w13
			// array('file' => 'home/index_content_13'),

			// w14
			// array('file' => 'home/index_content_14'),

			// w15
			// array('file' => 'home/index_content_15'),
			// array('file' => 'home/indexcontent15'),
