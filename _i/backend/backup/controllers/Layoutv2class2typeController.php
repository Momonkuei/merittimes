...
class Layoutv2class2typeController extends Controller {
	...
	protected $def = array(
		...
		'sortable' => array(
			...
			'url' => 'backend.php?r=layoutv2class2type/sort', // ajax post都會有個目標
		),
		// 建立前端要顯示的欄位
	...
	protected function beforeAction($action)
	{
		...
		$this->def['condition'][0][1] = 'type=\'layoutv2class2type\' and ml_key=\''.$this->data['admin_switch_data_ml_key'].'\' ';
		$this->def['sortable']['condition'] = 'type="layoutv2class2type" and ml_key="'.$this->data['admin_switch_data_ml_key'].'"';
