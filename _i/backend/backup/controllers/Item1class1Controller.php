...
class Item1class1Controller extends Controller {
	...
	protected $def = array(
		...
		'sortable' => array(
			...
			'url' => 'backend.php?r=item1class1/sort', // ajax post都會有個目標
		),
		// 建立前端要顯示的欄位
	...
	protected function beforeAction($action)
	{
		...
		$this->def['condition'][0][1] = 'type=\'item1class1\' and ml_key=\''.$this->data['admin_switch_data_ml_key'].'\' ';
		$this->def['sortable']['condition'] = 'type="item1class1" and ml_key="'.$this->data['admin_switch_data_ml_key'].'"';
