...
class NonameController extends Controller {
	...
	protected function beforeAction($action)
	{
		...
		$product_table = str_replace('browsersort', '', $product_table); // 為了支援產品的首頁排序
		...
		$this->def['condition'][0][1] = 'is_enable=1 and ml_key=\''.$this->data['admin_switch_data_ml_key'].'\' ';
		$this->def['sortable']['condition'] = 'is_enable=1 and ml_key="'.$this->data['admin_switch_data_ml_key'].'"';
