...
class IndexadController extends Controller
{
	protected $def = array(
		...
		'updatefield' => array(
			...
			'sections' => array(
				...
				array(
					...
					'type' => '1',
					'field' => array(
						'sys_config_indexad_title' => array(
							'label' => '廣告標題',
							//'mlabel' => array(
							//	null, // category
							//	'Title', // label
							...
							'type' => 'input',
							'attr' => array(
								'id' => 'sys_config_indexad_title',
								'name' => 'sys_config_indexad_title',
								'size' => '40',
							),
						),
						'sys_config_indexad_text' => array(
							'label' => '廣告連結',
							'type' => 'input',
							'attr' => array(
								'id' => 'sys_config_indexad_text',
								'name' => 'sys_config_indexad_text',
								'size' => '40',
							),
						),
						'pic2' => array(
							...
							'other' => array(
								...
								'width' => '846',
								'height' => '632',
								'comment_size' => '846x632',
								'no_ext' => '',
								'no_need_delete_button' => '',
							),
						),
						'sys_config_indexad_enable' => array(
							//'label' => 'ml:Status',
							'mlabel' => array(
								null, // category
								'Status', // label
							...
							'type' => 'status',
							'attr' => array(
								'id' => 'sys_config_indexad_enable',
								'name' => 'sys_config_indexad_enable',
							),
							'other' => array(
								'default'=>'1',
							),
	...
	public function actionIndex($param='')
	{
		if(empty($_POST)){
			...
			//處理單張圖片
			 $k = 'pic2_'.$this->data['admin_switch_data_ml_key'];
             if(isset($sys_configs[$k])){
				$this->data['updatecontent']['pic2_'.$this->data['admin_switch_data_ml_key']] = $sys_configs[$k];
...
array(9) {
  ...
  string(0) ""
			 ...
			 */
			 ...
			 //處理單張圖片
			$k1 = 'pic2_'.$this->data['admin_switch_data_ml_key'];
			$k2 = 'pic2';
			$v1 = $save[$k1];
