...
class NonameController extends Controller {
		...
		'updatefield' => array(
			...
			'sections' => array(
				...
				array(
					...
					'type' => '1',
					'field' => array(
						'sys_config_companyother_title' => array(
							//'label' => '標題',
							'mlabel' => array(
								null, // category
								'Title', // label
							...
							'type' => 'input',
							'attr' => array(
								'id' => 'sys_config_companyother_title',
								'name' => 'sys_config_companyother_title',
								'size' => '40',
							),
						),
						'sys_config_companyother_text' => array(
							'label' => '首頁公司簡介',
							'type' => 'ckeditor_js',
							'attr' => array(
								'id' => 'sys_config_companyother_text',
								'name' => 'sys_config_companyother_text',
							),
						),
						'pic1' => array(
							'label' => '圖片上傳：',
	...
	public function actionIndex($param='')
	{
		if(empty($_POST)){
			...
			//處理單張圖片
			 $k = 'pic1_'.$this->data['admin_switch_data_ml_key'];
             if(isset($sys_configs[$k])){
				$this->data['updatecontent']['pic1_'.$this->data['admin_switch_data_ml_key']] = $sys_configs[$k];
...
array(9) {
  ...
  string(0) ""
			 ...
			 */
			 ...
			 //處理單張圖片
			$k1 = 'pic1_'.$this->data['admin_switch_data_ml_key'];
			$k2 = 'pic1';
			$v1 = $save[$k1];
