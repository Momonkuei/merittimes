...
class NonameController extends Controller {
	...
	protected function beforeAction($action)
	{
		...
		$product_table = 'html';
		$class_name = str_replace('homesort', '', $this->data['router_class']); // 為了支援產品的首頁排序
		...
		$this->def['condition'][0][1] = 'is_home=1 and is_enable=1 and type=\''.$class_name.'\' and ml_key=\''.$this->data['admin_switch_data_ml_key'].'\' ';
		$this->def['sortable']['condition'] = 'is_home=1 and is_enable=1 and type="'.$class_name.'" and ml_key="'.$this->data['admin_switch_data_ml_key'].'"';
