			...
			'sections' => array(
				...
				array(
					...
					'field' => array(
						...
						'sys_config_banner_title' => array(
							'label' => '18度c版 - 下方title文字',
							'type' => 'input',
							'attr' => array(
								'class' => 'form-control', // 這…手動加上去好了
								'id' => 'sys_config_banner_title',
								'name' => 'sys_config_banner_title',								
								'size' => '20',
							),
						),
						/*
						'sys_config_homeother_text' => array(
							'label' => '首頁文字描述',
							'type' => 'ckeditor_js',
							'attr' => array(
								'id' => 'sys_config_homeother_text',
								'name' => 'sys_config_homeother_text',
							),
						),
