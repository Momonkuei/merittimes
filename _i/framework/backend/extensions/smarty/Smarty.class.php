 ...
 */
   ...
   /**
    ...
    // custom function gisanfu
	function smarty_htm_exists($filepath)
	{
        // 先寫成固定，後續在來修改，或者是除非要擴充的時候
        return template_path.'/'.$filepath;
        //        // 不處理^text:的功能
        //        if(preg_match('/^text\:/', $filepath)){
        //            return $filepath;
        //        }
		...
		//        $check = app_path.'/views/';
		//        $check .= $path.'/'.$filepath;

		//        if(!file_exists($check)){
        //            if($path != ''){
        //                $path = 'template';
        //                if(isset($template['author']) and $template['author'] != ''){
    ...
    function _smarty_include($params)
    {
        //var_dump($params);
        /*
         * 檢查template htm是否存在，不存在就試著載入default為名的路徑
         */
        $params['smarty_include_tpl_file'] = $this->smarty_htm_exists($params['smarty_include_tpl_file']);
        //echo $params['smarty_include_tpl_file'];
        //die;

        //$check = view_path.'/'.aaa_template_name.'/'.$params['smarty_include_tpl_file'];
        //if(!file_exists($check)){
        //    $params['smarty_include_tpl_file'] = '../default/'.$params['smarty_include_tpl_file'];
        //} else {
        //    $params['smarty_include_tpl_file'] = $check;
        //}
