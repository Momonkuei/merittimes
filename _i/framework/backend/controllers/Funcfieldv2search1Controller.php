...
class Funcfieldv2search1Controller extends Controller {

	protected $def = array(
		'table' => 'sys_func_v2_search1',
		'orm' => 'Empty_orm',
		...
		'sortable' => array(
			...
			'url' => 'backend.php?r=funcfieldv2search1/sort', // ajax post都會有個目標
		),
		// 建立前端要顯示的欄位
	...
	protected function beforeAction($action)
	{
		...
		$this->def['condition'][0][1] = 'is_enable=1 AND data_id=\''.$_SESSION['funcv2_searchfield_id_search1'].'\' ';
		$this->def['sortable']['condition'] = ' is_enable=1 AND data_id="'.$_SESSION['funcv2_searchfield_id_search1'].'"';
	...
	{   
		...
		$row = $this->db->createCommand()->from('sys_func_v2')->where('id='.$_SESSION['funcv2_searchfield_id_search1'])->queryRow();
	...
	protected function getdata()
	{
		...
		$this->multi_field_v1('updatefield01', 'sys_func_v2_search1_attr', 'keyname|keyvalue', 'keyname', 1);
		$this->multi_field_v1('updateother01', 'sys_func_v2_search1_other', 'keyname|keyvalue', 'keyname', 2);
	...
	{
		//var_dump($_POST);
		//echo $this->data['def']['updatefield']['method'];
		//die;
		$array['data_id'] = $_SESSION['funcv2_searchfield_id_search1'];
		return $array;
	}
	...
	protected function create_run_last()
	{
		...
		$_POST['updateother01']['from_user_id'] = $_SESSION['authw_admin_id'];
		$this->multi_field_v1('updateother01', 'sys_func_v2_search1_attr', 'keyname|keyvalue', 'keyname', 2);
	}
