...
class TemplatetypeController extends Controller {
	...
	protected $def = array(
		...
		'sortable' => array(
			...
			'url' => 'backend.php?r=templatetype/sort', // ajax post都會有個目標
		),
		// 建立前端要顯示的欄位
	...
	protected function beforeAction($action)
	{
		...
		$this->def['condition'][0][1] = 'type=\'templatetype\' ';
		$this->def['sortable']['condition'] = 'type="templatetype"';
