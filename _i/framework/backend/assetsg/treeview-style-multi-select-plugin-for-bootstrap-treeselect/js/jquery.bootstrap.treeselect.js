        ...
        function updateButtonText() {
            ...
            if (buttontext.length > 0) {
                if (buttontext.length < 4) {
                    ...
                    $button.children('span').text('所有項目己選擇'); // Alle items geselecteerd
                } else {
                    $button.children('span').text(buttontext.length + ' 項己選擇'); // items geselecteerd
                }
            } else {
