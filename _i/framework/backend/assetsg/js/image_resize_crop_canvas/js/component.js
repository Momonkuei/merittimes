...
var resizeableImage = function(image_target) {
  ...
  resizing = function(e){
	...
	// http://tympanus.net/codrops/2014/10/30/resizing-cropping-images-canvas/comment-page-2/#comment-463993
  ...
  crop = function(){
	...
	// gisanfu
	var posturl = $('.overlay').attr('posturl');
	var src_field = $('.overlay').attr('src_field');
	...
	$.ajax({
		...
		success: function(msg){
			if(msg != ''){
				d = new Date();
				$('#crop_'+src_field).attr('src', '/_i/' + msg + "?" + d.getTime() );
			} else {
				alert('Crop Fail !');
			}
		}
