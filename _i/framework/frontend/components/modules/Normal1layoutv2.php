...
public  function section_recursive($key)
{
	...
	//2016/1/11 設定子站layout路徑
	$layout_folder = 'layoutv2';
	if(isset($GLOBALS['layout_folder']))
		$layout_folder = $GLOBALS['layout_folder'];
...
XXX;
	...
	//} elseif(preg_match('/^view_(.*)$/', $type, $matches) and file_exists(Yii::getPathOfAlias('application').'/views/layoutv2/'.$type.'.php')){
		...
		if(file_exists(Yii::getPathOfAlias('application.views.'.$layout_folder).'/'.$type.'.php')){
			$return = $this->renderPartial('application.views.'.$layout_folder.'.'.$type, $this->data, true);
		} else {
...
public function actionDemopreview($type_backend)
{
	...
	if(file_exists(Yii::getPathOfAlias('application.views.'.$layout_folder).'/main.php')){
		include Yii::getPathOfAlias('application').'/views/'.$layout_folder.'/main.php';
	} else {
...
public function actionProductsortcount()
{
	if(!isset($_SESSION['productsortcount_'.$this->data['ml_key']]) or $_SESSION['productsortcount_'.$this->data['ml_key']] == 0){
		$_SESSION['productsortcount_'.$this->data['ml_key']] = 1;

		unset($_SESSION['productsortprice_'.$this->data['ml_key']]);
		unset($_SESSION['productsortcreatetime_'.$this->data['ml_key']]);

	} elseif($_SESSION['productsortcount_'.$this->data['ml_key']] == 1){
		$_SESSION['productsortcount_'.$this->data['ml_key']] = 2;

		unset($_SESSION['productsortprice_'.$this->data['ml_key']]);
		unset($_SESSION['productsortcreatetime_'.$this->data['ml_key']]);

	} elseif($_SESSION['productsortcount_'.$this->data['ml_key']] == 2){
		$_SESSION['productsortcount_'.$this->data['ml_key']] = 0;
...
public function actionProductsortprice()
{
	if(!isset($_SESSION['productsortprice_'.$this->data['ml_key']]) or $_SESSION['productsortprice_'.$this->data['ml_key']] == 0){
		$_SESSION['productsortprice_'.$this->data['ml_key']] = 1;

		unset($_SESSION['productsortcount_'.$this->data['ml_key']]);
		unset($_SESSION['productsortcreatetime_'.$this->data['ml_key']]);
	} elseif($_SESSION['productsortprice_'.$this->data['ml_key']] == 1){
		$_SESSION['productsortprice_'.$this->data['ml_key']] = 2;

		unset($_SESSION['productsortcount_'.$this->data['ml_key']]);
		unset($_SESSION['productsortcreatetime_'.$this->data['ml_key']]);

	} elseif($_SESSION['productsortprice_'.$this->data['ml_key']] == 2){
		$_SESSION['productsortprice_'.$this->data['ml_key']] = 0;
...
public function actionProductsortcreatetime()
{
	if(!isset($_SESSION['productsortcreatetime_'.$this->data['ml_key']]) or $_SESSION['productsortcreatetime_'.$this->data['ml_key']] == 0){
		$_SESSION['productsortcreatetime_'.$this->data['ml_key']] = 1;

		unset($_SESSION['productsortcount_'.$this->data['ml_key']]);
		unset($_SESSION['productsortprice_'.$this->data['ml_key']]);

	} elseif($_SESSION['productsortcreatetime_'.$this->data['ml_key']] == 1){
		$_SESSION['productsortcreatetime_'.$this->data['ml_key']] = 2;

		unset($_SESSION['productsortcount_'.$this->data['ml_key']]);
		unset($_SESSION['productsortprice_'.$this->data['ml_key']]);

	} elseif($_SESSION['productsortcreatetime_'.$this->data['ml_key']] == 2){
		$_SESSION['productsortcreatetime_'.$this->data['ml_key']] = 0;
...
public function actionContact()
{
	if(empty($_POST)){
		...
		// 主旨
		$subject = $this->data['sys_configs']['admin_title'].' Contact Us '.G::t(null,'客戶聯絡信件');
