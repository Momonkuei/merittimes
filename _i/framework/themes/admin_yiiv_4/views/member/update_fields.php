...
<?php endif?>
	...
	<div class="portlet box light-grey">
		<div class="portlet-title">
			<h4><i class="icon-reorder"></i><?php if(isset($v['section_title']) and $v['section_title'] != ''):?><a name="<?php echo $v['section_title']?>"></a><?php echo $v['section_title']?><?php endif?></h4>
			<div class="tools">
				<a class="<?php if(isset($v['section_disable']) and $v['section_disable'] == true):?>expand<?php else:?>collapse<?php endif?>" href="javascript:;"></a>
				<?php if(0):?>
