...
<div class="row-fluid">
	...
	<?php endif?>
		...
		<?php echo $this->renderPartial('//reportmemberbyorderid/pagination4c', $this->data)?>
...
<?php endif?>
		...
		<table id="tablelist" class="table1 sortable table table-striped table-bordered table-hover dataTable" aria-describedby="sample_1_info">
			<?php if(isset($listcontent_title) and $listcontent_title != ''): ?>
				<caption style="background-color: #DDDDDD;"><h3><?php echo $listcontent_title?></h3></caption>
			<?php endif?>
			<thead>
			<tr>
				<?php // 顯示欄位名稱，包含排序 ?>
