...
<?php elseif(isset($this->data['vv_type_select']) and $this->data['vv_type_select'] == 'view'):?>
	...
	<?php if(isset($vv['other']['html_start'])):?><?php echo $vv['other']['html_start']?><?php endif?>
		<?php if(isset($vv['other']['label'])):?><label><?php endif?>
			<input <?php echo $formattr?> type="checkbox" <?php if(isset($updatecontent[$kk]) and isset($vv['attr']['value']) and $updatecontent[$kk] == $vv['attr']['value']):?>checked="checked"<?php endif?> /><?php if(isset($vv['other']['label'])):?><?php echo $vv['other']['label']?><?php endif?>
		<?php if(isset($vv['other']['label'])):?></label><?php endif?>
