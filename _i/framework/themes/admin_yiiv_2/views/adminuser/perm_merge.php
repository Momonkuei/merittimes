<fieldset>
	...
	<dl class="inline">
		...
		<dd>
			<label title="打勾以外的都能用，也就是打勾的不能用以外"> &nbsp;<?php G::te(null, 'Revert', array(), '反向') ?>&nbsp;</label> | 
			<label title="打勾就是能用，反之"> &nbsp;<?php G::te(null, 'Simple', array(), '簡易') ?>&nbsp;</label> | 
			<label title="跟簡易一樣，但是可以細到例如能不能新增等">&nbsp;&nbsp;<?php G::te(null, 'Professional Permission', array(), '進 階 授 權') ?></label>
		</dd>
		<?php if(0):?>
			<dt><label>------------</label></dt>
			<dd>-------- | ---------------------------------------</dd>
