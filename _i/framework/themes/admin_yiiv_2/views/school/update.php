...
<section id="main" class="grid_9 push_3">
	...
	<?php if(!empty($def['updatefield'])):?>
		...
		<div class="buttons" style="clear:both;">
			...
			<button onclick="document.location.href='<?php echo $class_url?>';" class="button white" type="button"><?php G::te($this->data['theme_lang'], 'Previous', null, '上一頁')?></button>
			<?php else:?>
	...
	<?php if(isset($updatecontent['pid']) and $updatecontent['pid'] == 0):?>
		...
		<form>
			...
			<table id="tablelist" class="gtable sortable">
				<thead>
				<tr>
					<?php // 顯示欄位名稱，包含排序 ?>
				...
				<tr class="" id="sortable_id_<?php echo $v['id']?>">
