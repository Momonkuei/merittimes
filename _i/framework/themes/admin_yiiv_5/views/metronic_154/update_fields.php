<?php if(!empty($def['updatefield']['sections'])):?>
	...
	<div class="portlet-body form" <?php if(isset($v['section_disable']) and $v['section_disable'] == true):?>style="display:none"<?php endif?>>
		...
		<?php if(!empty($v['field']) and isset($v['type'])):?>
				<?php if($v['type'] == '1' or $v['type'] == '2'):?>
					<div class="form-body">
						<?php $this->data['k'] = $k?>
						<?php $this->data['v'] = $v?>
						<?php echo $this->renderPartial('metronic_154/update_fields_section', $this->data)?>
					</div>
				<?php endif?>
				<?php if($v['type'] == '3'):?>
					<?php $this->data['k'] = $k?>
		...
		<?php // 合併簡易和進階授權表 ?>
		<?php echo $this->renderPartial('metronic_154/perm_merge', $this->data)?>
