...
if(isset($def['sortable']['enable']) and $class_id > 0 and $def['sortable']['enable'] == true and (($sort_field_nobase64 == $sort_id_tmp and $sort_direction == 'asc') or ($sort_field == '' and $sort_direction == '' and $def['default_sort_field'] == $sort_id_tmp)) ){ 
...
<?php endif?>
			<tr class="<?php echo ($k%2==1)?'even':'odd' ?>" id="sortable_id_<?php echo $v['id']?>">
			...
			<?php // 2015/5/21的新功能?>
			<?php if(isset($listcontent_row_details_open[$v['id']])):?>
			<tr class="row_details_open" id="row_details_open_<?php echo $v['id']?>">
				<td class="details" colspan="6">
					<?php echo $listcontent_row_details_open[$v['id']]?>
				</td>
			</tr>
			<?php endif?>
