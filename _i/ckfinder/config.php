<?php
error_reporting(0); //有些環境會顯示Notice錯誤碼而導致無法上傳，先加上去再說 by lota 2021-06-24
/*
...
$baseUrl = preg_replace('@/+$@','',dirname(dirname(dirname(dirname(dirname($_SERVER['SCRIPT_NAME'])))))).'/assets/upload/'; // 2018/1/25 改回原本的，為了支援次層網站目錄 by lota
...
//$baseDir = resolveUrl($baseUrl);
session_start();
$baseDir = $_SESSION['tmp_path'].'/upload/'; // lota 發現的bug 2015-08-28
...
2016/5/10 leo反應編輯器上圖會等比縮，將原上限1600*1200 調整到 16000 * 12000
*/
$config['Images'] = Array(
		'maxWidth' => 16000,
		'maxHeight' => 12000,
