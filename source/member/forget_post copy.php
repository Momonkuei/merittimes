...
<div class="member_mail">
      <p class="tit">親愛的會員 $aaa_name 您好，</p>
      <h1><p>我們收到您在 $aaa_admin_title 的密碼重設申請，<br>
      	請進入下面的連結開始進行密碼重設，<br>
      	<a href="$aaa_url/memberforgetconfirm_$ml_key.php?e=$random_hash">$aaa_url/memberforgetconfirm_$ml_key.php?e=$random_hash</a></p>
      </h1>
      <h2><p>如果您無法點選以上連結，請將上方的連結複製，並到您的瀏灠器的網址列 貼上，執行 (Enter) </p></h2>
      <h1><p>若您已完成確認作業，請忽略本通知勿需作任何處理。<br>
      	如果您沒有重設密碼，或有其他任何問題，請聯絡我們。</p>
      <p>$aaa_admin_title</p></h1>
</div>
