 ...
 * @param int    $rowsCnt   行數(传0则自动获取最大行) by lota
...
function importExecl(string $file = '', int $sheet = 0, int $columnCnt = 0, int $rowsCnt = 0, &$options = [])
{
    try {
        /* 转码 */
