...
if(
	isset($_POST['captcha']) and $_POST['captcha'] != '' and $_POST['captcha'] == $_SESSION['cssv6_captcha'] 
...
$_SESSION['cssv6_captcha'] = substr(md5(microtime()),rand(0,26),15);
...
<html>
<head>
<title>CSS Compiler version6</title>
	...
	sass.preloadFiles('../../../css/', '', files.split(","), function() {
		...
		sass.compileFile('themeg.scss', function(result) {                  
			...
			$.ajax({
				type: "POST",
				data: {
					'captcha': '<?php echo $_SESSION['cssv6_captcha']?>',
					'result': result.text
				},
				url: 'cssv6.php',
