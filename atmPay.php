...
if(!empty($donation_data) && $donation_data['keyval']=='true'){
   ...
   */
   ...
   try {
      ...
      $obj->Send['ReturnURL']         = $url."/atmPay_back.php" ;    //付款完成通知回傳的網址
      ...
      //訂單的商品資料
      array_push($obj->Send['Items'], array('Name' => "此次捐款項目", 'Price' => (int)$result['total'],
                  'Currency' => "元", 'Quantity' => (int) "1", 'URL' => "dedwed"));


      $obj->SendExtend['ExpireDate'] = 3 ; //繳費期限 (預設3天，最長60天，最短1天)
      $obj->SendExtend['PaymentInfoURL'] =  $url."/atmPay_code_back.php" ;//伺服器端回傳付款相關資訊。
